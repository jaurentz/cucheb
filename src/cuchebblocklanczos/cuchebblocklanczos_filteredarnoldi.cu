...
int cuchebblocklanczos_filteredarnoldi(cuchebmatrix* ccm, cuchebpoly* ccp, cuchebblocklanczos* ccb){
  ...
  // copy data to host
  cudaMemcpy(&(ccb->schurvecs)[0],&dschurvecs[0],nvecs*(nvecs+bsize)*sizeof(double),
